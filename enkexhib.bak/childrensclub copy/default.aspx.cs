...
public partial class _default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
				...
				if (Session["idxEID"] == null)
		{
			...
			Response.Redirect("~/login.aspx?ReturnUrl=%2finfo%2fchildrensclub%2fdefault.aspx");
		}
		else
		{
        Int32.TryParse(Session["idxEID"].ToString(),out idxeidint);
            ...
            DataTable dt = da.SelectExhibitorByidxEIDShowCode(idxeidint,"CC");//SelectExhibitorByCoNumber(Co);
