    ...
    <div class="main">
      ...
      <div class="main--content">
          ...
          <ul>
            ...
            <li><a href="#floor-plan">Floor Plans</a>
              <ul class="sub-nav">
                ...
                <li><a href="../assets/pdf/acic/acic-aug2014-exhibitor_map.pdf" target="_blank">Detailed Floorplan</a></li>
              </ul>
            </li> 
        ...
        <div class="exhib-content" id="order-form">
          ...
          <a href="http://www.enkforms.com/expressform/acic_aug2014/" target="_blank">Visit the online order form here</a>
        </div>
        <div class="exhib-content" id="buyer-lead">
          <h3>Buyer Lead Retrieval Scanner</h3>
          <p>We are pleased to offer participating vendors a customized Lead Retrieval Program for tracking attendees in your exhibit booth at Accessorie Circuit/Intermezzo Collections, Aug. 3-5, 2014, Javits Center, New York, NY.</p>
          ...
          <p>For more information, please click here: <a href="../assets/pdf/acic/acic-aug2014-buyer-lead.pdf">Velocity Scanner</a>.</p>
        ...
        <div class="exhib-content" id="guidebook">
          ...
          <div class="guide-exhib-l">
            ...
            <p>Please note that if you do not complete and submit the <a href="http://www.enkforms.com/expressform/acic_aug2014/" target="_blank">Online Order Form</a> by the July 18 deadline, you will receive the frame-work, hard-walls and lighting ONLY. You will NOT receive Furnishings. Please be sure to complete the <a href="http://www.enkforms.com/expressform/acic_aug2014/" target="_blank">Online Order Form</a> by the July 18 deadline date to receive the furnishings you require</p>
          ...
          <div class="guide-exhib-r">
            ...
            <ul>
              ...
              <li><span>37</span><a href="http://www.enkforms.com/expressform/acic_aug2014/"> Online Order Form</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="exhib-content" id="floor-plan">
          ...
          <h4>Javits Center</h4>
          <a class="map-image" href="../assets/pdf/acic/acic-aug2014-exhibitor_map.pdf">
       ...
       <!--  <div class="exhib-content" id="travel-advisory">
        ...
        <div class="exhib-content" id="faq">
          ...
          <div class="faq-content">
            ...
            <p>You may now order your ENK booth package, additional furnishing or lighting, mannequins/steams, BoothSeal, etc. easily and direct from your computer via our <a href="http://www.enkforms.com/expressform/acic_aug2014/" target="_blank">Online Express Order Form</a>.</p>
            <!-- Question 4 -->
            <h4></h4>
          ...
          <div class="faq-content">
            ...
            <p>All union labor must be ordered and organized through GES.  Place any labor orders with GES in advance, to help assure that the required work can be done in the most economical fashion.  Refer to the <a href="http://www.enkforms.com/expressform/acic_aug2014/" target="_blank">Online Order Form</a>.</p>
          </div>
